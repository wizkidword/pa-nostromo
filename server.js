...
const { handleApiHomeDevicePing, handleApiHomeDeviceWake } = createHomeDevicesApiHandlers({
  sendJson,
  readBody,
  parseJsonSafely,
  ...
  runExecFile,
  buildPingArgs,
  timeoutMs: HOME_DEVICE_TIMEOUT_MS,
  logDiagnostic,
});
...
const handleApiGasPrices = createGasPricesApiHandler({
  sendJson,
  createClientAbortSignal,
...
const handleApiRssFetch = createRssApiHandler({
  sendJson,
  readBody,
  bodyLimit: REQUEST_BODY_LIMIT_RSS_BYTES,
  maxFeeds: RSS_FETCH_MAX_FEEDS,
  maxEntries: RSS_FETCH_MAX_ENTRIES,
  fetchFeedXml,
  parseFeedXml,
  createClientAbortSignal,
  isPayloadTooLargeError,
